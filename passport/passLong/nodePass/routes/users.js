...
module.exports = function(app, passport, errors) {
  ...
  app.get('/users/register', function(req, res) {
    ...
    if (req.isAuthenticated()){
      ...
      // console.log("dang register ne, aaa")
      // console.log(`errors ne: ${JSON.stringify(errors)}`)
      res.render('register.ejs',{errors});
    }
    
});
// app.get('/users/register', (req, res) => res.render('register.ejs', { message: req.flash('registerMessage')}));
